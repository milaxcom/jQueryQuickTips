...
var QuickTips=function(a,b){a=a||!1;b=b||{};objectTypeof=typeof a;switch(objectTypeof){case "object":a.on("mouseenter.quicktips",function(){QuickTips.show.call(this,b)});break;case "string":$(document).on("mouseenter.quicktips",a,function(){QuickTips.show.call(this,b)});break;default:var c="undefined"!=typeof $.browser?!0:!1;if(c)var d=1==$.browser.msie?!0:!1,e=9>1*$.browser.version?!0:!1;QuickTips.oldIE=c&&d&&e?!0:!1;QuickTips(".quick-tips")}};
...
QuickTips.position=function(a){a.ps={};a.pt={};a.pa={};var b=$(this).offset();a.ps.top=b.top;a.ps.left=b.left;a.ps.width=$(this).outerWidth();a.ps.height=$(this).outerHeight();a.pt.width=1*a.option.width;a.pt.top=a.ps.top+a.ps.height+a.option.space;a=QuickTips.position.leftAndArrow(a);a.$element.css({left:a.pt.left,top:a.pt.top});a.$arrow.css({left:a.pa.left,top:a.pa.top});return a};
QuickTips.position.leftAndArrow=function(a){QuickTips.oldIE?a.$arrow.hide():a.pt.top=1*a.pt.top+4;a.pa.top=-4;a.pt.left=1*a.ps.left+Math.round(a.ps.width/2)-Math.round(a.pt.width/2);a.pa.left=Math.round(a.pt.width/2)-Math.round(4);if(a.option["check-frame"]){var b=$(document).width();0>a.pt.left&&(a.pt.left=a.ps.left,a.pa.left=6);a.pt.left+a.pt.width>b&&(a.pt.left=a.ps.left+a.ps.width-a.pt.width,a.pa.left=a.pt.width-8-6)}return a};
